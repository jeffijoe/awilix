...
describe('local injections', function () {
  it('invokes the injector and provides the result to the constructor', function () {
    ...
    expect(() => container.cradle.test2.value).to.throw(/Could not resolve 'value'/)
  })
  ...
  it('supported by registerClass', function () {
    const container = createContainer()
      .registerClass({
        test: [Test, { injector }],
        testClassic: [TestClassic, { injector, resolutionMode: ResolutionMode.CLASSIC }],
        test2: Test
      })
  ...
  it('supported by registerFunction', function () {
    const container = createContainer()
      .registerFunction({
        ...
        testClassic: [makeCLassicTest, { injector, resolutionMode: ResolutionMode.CLASSIC }],
        test2: makeTest
      })
