...
/**
 * Prints a deprecation message the first time it is called.
 * @param {String} message
 */
module.exports.deprecated = function deprecated(message) {
  if (module.exports.deprecated.called.indexOf(message) > -1) {
    return
  }
  module.exports.deprecated.called.push(message)
  console.log('\x1b[33m%s\x1b[0m', '[awilix] ' + message)
}

module.exports.deprecated.called = []
