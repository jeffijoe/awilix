...
module.exports = function createContainer(options, __parentContainer) {
  ...
  const familyTree = __parentContainer
    ? [container].concat(__parentContainer.familyTree)
    : [container];
   ...
   * @type {object[]}
   */
  container.familyTree = familyTree;
  ...
  const rollUpRegistrations = () => {
    return Object.assign({}, registrations, __parentContainer && __parentContainer.registrations);
  };
